...
B('cat ~/.config/google-chrome/Default/Cookies','SENSITIVE_PATH');
B('cat /home/user/.mozilla/firefox/xxxxx.default/cookies.sqlite','SENSITIVE_PATH');
B('sqlite3 ~/.config/google-chrome/Default/Cookies "select * from cookies"','SENSITIVE_PATH');
B('cat /data/data/com.android.chrome/app_chrome/Default/Cookies','SENSITIVE_PATH');
B('cp ~/.config/microsoft-edge/Default/"Login Data" /tmp/x','SENSITIVE_PATH');
B('cat ~/.mozilla/firefox/xxxxx.default/logins.json','SENSITIVE_PATH');
